    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Radio(activeColor: Colors.red, value: 1, groupValue: groupValue, onChanged: (e) => handleTemperature(e!)),
              Text("Fahrenheit To Celsius"),
              SizedBox(
                height: 5.0,
              ),
              Radio(activeColor: Colors.red, value: 2, groupValue: groupValue, onChanged: (e) => handleTemperature(e!)),
